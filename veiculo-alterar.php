...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-md-offset-2">
                            <div>
                                ...
                                <select id="categoria" name="id_categoria" class="form-control" value="<?php echo $veiculo['id_categoria']; ?>">
    ...
    <script>
        $(function(){
            var idCategoria = <?php echo $categoriaV['id_categoria']; ?>;
            $("#categoria").find('option').each(function(){
                if($(this).val() ==  idCategoria){
